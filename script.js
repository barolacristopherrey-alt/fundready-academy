...
══════════════════════════════════════════════════════ */
const WORKBOOKS = [
  {id:1, title:'Your NGO Case for Support', category:'foundations', color:'var(--emerald)', colorPale:'var(--emerald-pale)', exercises:6, minutes:45, level:'Beginner',
   desc:'Build a compelling, evidence-based case for support from scratch. Covers mission clarity, impact data, and emotional storytelling.',
   steps:['Define your mission in one sentence donors understand','Identify your 3 core programs as fundable offers','Gather 5 impact data points with sources','Write your beneficiary story (150 words)','Draft the one-page case for support','Test with 2 external readers and revise'],
   output:'A polished one-page case for support ready to send to donors and funders.'},

  {id:2, title:'Grant Proposal Builder', category:'grants', color:'var(--gold)', colorPale:'var(--gold-pale)', exercises:8, minutes:60, level:'Intermediate',
   desc:'Walk through each section of a winning grant proposal — problem statement, objectives, budget narrative, and evaluation framework — with worked examples.',
   steps:['Map your program to the funder\'s stated priorities','Write a 3-paragraph problem statement with data','Define 3–5 SMART objectives','Draft your methodology and activity timeline','Build a line-item budget with narrative','Design your monitoring & evaluation framework','Write the executive summary last','Proofread against the funder\'s checklist'],
   output:'A complete first draft of a grant proposal ready for internal review.'},

  {id:3, title:'Donor Pipeline Workbook', category:'individual-giving', color:'var(--sky)', colorPale:'var(--sky-pale)', exercises:5, minutes:40, level:'Beginner',
   desc:'Map your top 20 donor prospects, score each for readiness and capacity, and build a 90-day cultivation plan.',
   steps:['List 20 prospective donors across 3 tiers','Score each on alignment, capacity, and warmth','Assign a next action and owner to each','Map a 3-touch cultivation sequence per tier','Build your 90-day outreach calendar'],
   output:'A live donor pipeline with 20 prospects, scores, and a 90-day action plan.'},

  {id:4, title:'Digital Campaign Planner', category:'digital', color:'var(--rose)', colorPale:'var(--rose-pale)', exercises:7, minutes:50, level:'Intermediate',
   desc:'Design a full online fundraising campaign from goal-setting to post-campaign reporting. Includes content calendar and donor page checklist.',
   steps:['Set campaign goal, timeline, and target audience','Choose your platform and configure donation page','Write 7 content pieces for Week 1 calendar','Build your WhatsApp ambassador script','Create a peer-to-peer ask template','Draft your closing push message (Day 12–14)','Design a post-campaign donor thank-you sequence'],
   output:'A complete 14-day campaign plan with content calendar and donor page checklist.'},

  {id:5, title:'Annual Fundraising Strategy', category:'strategy', color:'var(--emerald)', colorPale:'var(--emerald-pale)', exercises:9, minutes:75, level:'Advanced',
   desc:'Set annual revenue targets by stream, map your key funding relationships, and build a month-by-month execution calendar.',
   steps:['Audit last year\'s income by funding stream','Set targets for individual, grants, corporate, digital','Map your top 10 funder relationships by tier','Identify 3 new opportunities per stream','Build a 12-month activity and deadline calendar','Assign budget and team responsibilities','Define quarterly review milestones','Create a risk register with contingencies','Write a 1-page strategy summary for your board'],
   output:'A board-ready annual fundraising strategy with targets, calendar, and responsibilities.'},

  {id:6, title:'Impact Measurement Workbook', category:'reporting', color:'var(--gold)', colorPale:'var(--gold-pale)', exercises:6, minutes:50, level:'Intermediate',
   desc:'Define your theory of change, select outcome indicators, and create a one-page impact report template.',
   steps:['Draw your theory of change (inputs → activities → outputs → outcomes → impact)','Select 3 output indicators with data collection methods','Select 2 outcome indicators with baselines','Design a simple data collection tool','Write a one-page impact narrative','Build a donor-facing impact report template'],
   output:'A theory of change, 5 KPIs with data collection tools, and a one-page impact report.'},

  {id:7, title:'Corporate Partnership Pitch', category:'strategy', color:'var(--sky)', colorPale:'var(--sky-pale)', exercises:5, minutes:45, level:'Intermediate',
   desc:'Research a corporate prospect, align your program to their CSR priorities, and build a tailored partnership pitch deck.',
   steps:['Research the company\'s CSR focus and past NGO partners','Map your programs to their stated priorities','Define 3 partnership tiers (Bronze/Silver/Gold)','Write a 2-page partnership brief','Prepare a 5-slide pitch deck'],
   output:'A tailored 2-page partnership brief and 5-slide pitch deck ready to present.'},

  {id:8, title:'Foundation Grant Research Kit', category:'grants', color:'var(--rose)', colorPale:'var(--rose-pale)', exercises:6, minutes:55, level:'Beginner',
   desc:'Find and qualify 10 foundation prospects, assess fit, and build a 6-month grant application calendar.',
   steps:['Define your ideal funder profile (sector, geography, size)','Use 3 databases to research 20 foundation prospects','Score each on alignment, capacity, and deadline fit','Shortlist your top 10 and review past grantees','Map application deadlines to a 6-month calendar','Draft outreach emails to 3 programme officers'],
   output:'A shortlist of 10 qualified foundation prospects with a 6-month grant calendar.'},

  {id:9, title:'Donor Stewardship Playbook', category:'individual-giving', color:'var(--emerald)', colorPale:'var(--emerald-pale)', exercises:5, minutes:40, level:'Beginner',
   desc:'Design a 90-day stewardship journey for first-time donors — from thank-you to renewal ask.',
   steps:['Write a 24-hour thank-you message template','Build a 30-day welcome journey (3 touchpoints)','Create a 60-day engagement check-in','Draft a 90-day renewal proposal','Design a recurring donor upgrade ask'],
   output:'A complete 90-day donor stewardship playbook with templates for every touchpoint.'},

  {id:10, title:'Funding Mix Diagnostic', category:'foundations', color:'var(--gold)', colorPale:'var(--gold-pale)', exercises:4, minutes:30, level:'Beginner',
   desc:'Assess your current funding mix, identify over-dependencies, and design a more resilient income strategy.',
   steps:['Map last 3 years of income by source (% per stream)','Identify streams over 40% (vulnerability test)','Research 2 new diversification opportunities','Write a 6-month diversification action plan'],
   output:'A funding mix audit with a risk assessment and a diversification roadmap.'},

  {id:11, title:'Fundraising Team Roles & Routines', category:'strategy', color:'var(--rose)', colorPale:'var(--rose-pale)', exercises:5, minutes:40, level:'Intermediate',
   desc:'Define fundraising responsibilities across your team and build a weekly/monthly operating rhythm.',
   steps:['Map current fundraising tasks to existing staff roles','Identify gaps and define 3 priority role additions','Design a weekly fundraising team check-in agenda','Build a monthly fundraising review template','Document the annual planning cycle'],
   output:'A fundraising RACI chart, weekly meeting template, and monthly review dashboard.'},

  {id:12, title:'Proposal Review & Scoring Guide', category:'grants', color:'var(--sky)', colorPale:'var(--sky-pale)', exercises:4, minutes:30, level:'Advanced',
   desc:'Learn to read proposals like a funder — build a scoring rubric and use it to self-review your own submissions.',
   steps:['Study 3 public scoring rubrics from institutional funders','Build your own 10-criteria scoring rubric','Score a past proposal draft using your rubric','Rewrite the weakest-scoring section'],
   output:'A 10-criteria self-review rubric and a revised proposal section scored at 8/10 or above.'},
];

const WB_COLORS = {
  foundations:'var(--emerald)', grants:'var(--gold)', 'individual-giving':'var(--sky)',
  digital:'var(--rose)', strategy:'#7c3aed', reporting:'var(--gold)'
};
const WB_COLOR_PALES = {
  foundations:'var(--emerald-pale)', grants:'var(--gold-pale)', 'individual-giving':'var(--sky-pale)',
  digital:'var(--rose-pale)', strategy:'#f5f3ff', reporting:'var(--gold-pale)'
};
const WB_LABELS = {
  foundations:'Foundations', grants:'Grants', 'individual-giving':'Individual Giving',
  digital:'Digital', strategy:'Strategy', reporting:'Reporting'
};
let _wbFilter = 'all';
...
function renderWorkbooks() {
  ...
  grid.innerHTML = list.map(w => {
    ...
    return `
    <div class="tool-card" style="cursor:pointer;display:flex;flex-direction:column" onclick="openWorkbookModal(${w.id})">
      <div style="display:flex;align-items:flex-start;gap:12px;margin-bottom:12px">
        <div style="width:44px;height:44px;border-radius:10px;background:${pale};display:flex;align-items:center;justify-content:center;font-size:22px;flex-shrink:0">📓</div>
        <div style="flex:1;min-width:0">
          <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;flex-wrap:wrap">
            <span style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;background:${pale};color:${col};padding:2px 8px;border-radius:100px">${lbl}</span>
          </div>
...
function openWorkbookModal(id) {
  ...
  openModal('' + w.title, `
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:14px">
      <span style="background:${pale};color:${col};padding:3px 12px;border-radius:100px;font-size:12px;font-weight:700;text-transform:capitalize">${lbl}</span>
      <span style="background:var(--paper);color:var(--ink-soft);padding:3px 12px;border-radius:100px;font-size:12px">${w.exercises} exercises · ~${w.minutes} min</span>
    </div>
...
const VG_WORKBOOK_MAP = {
  1:  3,   /* Grant Proposal → Grant Writing Workbook */
  2:  8,   /* Major Donor Pipeline → Pipeline Builder Workbook */
  3:  1,   /* Case for Support → Case for Support Workbook */
  4:  6,   /* Online Campaign → Digital Campaign Workbook */
  5:  10,  /* Annual Strategy → Annual Fundraising Strategy Workbook */
  6:  3,   /* Due Diligence → Grant Writing Workbook */
  7:  1,   /* Thank-You → Case for Support Workbook */
  8:  7,   /* Corporate Fundraising → Corporate Fundraising Workbook */
  9:  11,  /* Impact Reporting → Impact Report Workbook */
  10: 3,   /* Grant Calendar → Grant Writing Workbook */
  11: 6,   /* Social Media → Digital Campaign Workbook */
  12: 10,  /* 90-Day Sprint → Annual Fundraising Strategy Workbook */
  13: 8,   /* Prospect Research → Pipeline Builder Workbook */
  14: 8,   /* Ask Meeting → Pipeline Builder Workbook */
  15: 6,   /* Email Sequences → Digital Campaign Workbook */
  16: 10,  /* Board Fundraising → Annual Fundraising Strategy Workbook */
  17: 10,  /* Diversification → Annual Fundraising Strategy Workbook */
  18: 6,   /* Year-End Giving → Digital Campaign Workbook */
};
let _vgFilter = 'all';
...
function renderAIAdvisor() {
  window._GROQ_KEY = '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';
...
const CAP_IMPROVE_MAP = {
  1:{ toolIds:[1], wbIds:[10,5],  storyIds:[1],    videoIds:[5,12] },
  2:{ toolIds:[2], wbIds:[1],     storyIds:[6],    videoIds:[3,7]  },
  3:{ toolIds:[3], wbIds:[1,2],   storyIds:[2,6],  videoIds:[3,6]  },
  4:{ toolIds:[4], wbIds:[3,8],   storyIds:[7],    videoIds:[13,2] },
  5:{ toolIds:[4,5],wbIds:[3,9],  storyIds:[7],    videoIds:[2,14] },
  6:{ toolIds:[6], wbIds:[3],     storyIds:[1,7],  videoIds:[14,15]},
  7:{ toolIds:[6,7],wbIds:[2,8,12],storyIds:[2],   videoIds:[1,6,10]},
  8:{ toolIds:[8], wbIds:[7],     storyIds:[5],    videoIds:[8,17] },
  9:{ toolIds:[9], wbIds:[4],     storyIds:[4,8],  videoIds:[4,11,18]},
  10:{toolIds:[10],wbIds:[9,6],   storyIds:[3],    videoIds:[7,9,15]},
};
...
const IMPROVEMENT_TRACKS = [
  {
    ...
    steps: [
      ...
      { title: 'Set your fundraising goals & channels', desc: 'Define 2–3 priority funding channels and write specific, measurable targets for the next 12 months.', action: 'openWorkbookModal', actionArg: 10, actionLabel: 'Open Goals Workbook' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Write your one-page case for support', desc: 'Use the Case for Support workbook to draft a compelling one-pager: problem → solution → proof → ask.', action: 'openWorkbookModal', actionArg: 1, actionLabel: 'Open Case for Support Workbook' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Build your grant pipeline', desc: 'Use the grant go/no-go matrix to shortlist 3–5 real opportunities and begin your first full proposal using the 2-page template.', action: 'openWorkbookModal', actionArg: 2, actionLabel: 'Open Grant Proposal Workbook' },
      ...
      { title: 'Design your first digital campaign', desc: 'Choose a compelling campaign hook, set a clear unit-cost goal, and build a 14-day content calendar ready to launch.', action: 'openWorkbookModal', actionArg: 4, actionLabel: 'Open Campaign Workbook' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Map your 30/60/90 donor journey', desc: 'Plan exactly what communication donors receive at 30, 60, and 90 days after their first gift — keeping them connected and ready for the renewal ask.', action: 'openWorkbookModal', actionArg: 9, actionLabel: 'Open Retention Workbook' },
      ...
      { title: 'Set up your quarterly reporting rhythm', desc: 'Build a repeatable quarterly impact reporting system so you never go more than 3 months without connecting with your donor base.', action: 'openWorkbookModal', actionArg: 6, actionLabel: 'Open Reporting Workbook' },
    ],
    toolIds: [2, 10],
    wbIds: [9, 6, 1],
